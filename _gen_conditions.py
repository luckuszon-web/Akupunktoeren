...
BOOK_TEXT = '''
    ...
    <p>Har du yderligere spørgsmål, er du velkommen til at skrive en mail på <a href="mailto:ckuszon@akupunktoeren.com" style="color:var(--color-accent)">ckuszon@akupunktoeren.com</a> eller ringe til os på telefon 31 60 88 80.</p>''' + CTA_BUTTONS
...
article(
    ...
    <p>På Akupunkturklinik Charlotte Kuszon har vi erfaring med behandling af en lang række smerter og spændinger, hvor vi har set rigtig gode resultater ved brug af akupunktur.</p>
    ...
    <p>Sammen med dig finder vi årsagen til dine smerter og får tilrettelagt et behandlingsforløb, hvor vi retter op på problemet. <a href="../posturologi/" style="color:var(--color-accent)">Læs mere om posturologi her.</a></p>''',
)
...
article(
    ...
    <p>Efter en grundig snak med dig om problemet tilrettelægger vi et behandlingsforløb, som er skræddersyet efter dine behov. <a href="../posturologi/" style="color:var(--color-accent)">Læs mere om posturologi her.</a></p>''',
)
...
article(
    ...
    <p>Vi har rigtig gode erfaringer med at behandle tinnitus ved hjælp af akupunktur og på den måde enten få den generende lyd helt væk eller i hvert fald forbedre tilstanden væsentligt.</p>
    <h3>Behandling af forskellige typer tinnitus</h3>
    <p>Vi udfører forskellige behandlinger alt efter, hvilken type tinnitus der er tale om. Nogle tinnituspatienter oplever en susen for ørerne, mens andre generes af en konstant hyletone. Inden behandlingen går i gang, kortlægger jeg sammen med dig typen af tinnitus, så vi sikrer den rette behandling.</p>''',
)
...
article(
    ...
    <p>Akupunktur er utrolig effektivt mod høfeber og allergi generelt. Faktisk så effektiv, at langt de fleste høfeberpatienter, vi behandler med akupunktur, får det bedre eller slipper helt af med høfeberen.</p>
    <h3>Rigtig gode resultater ved behandling af høfeber</h3>
    <p>Ved hjælp af akupunktur kan vi styrke kroppens immunforsvar og derved minimere medicinforbrug, snue, kløende og røde øjne i forbindelse med høfeber. Erfaringen er, at man meget hurtigt mærker resultater ved akupunkturbehandlinger mod høfeber.</p>
    <p>Høfeberen kan behandles, selvom allergien er startet, men vi anbefaler, at du starter behandlingsforløbet lige inden "allergisæsonen" går i gang.</p>''',
)
...
article(
    ...
    <p>På Akupunkturklinik Charlotte Kuszon har vi stor erfaring med behandling af astma, lungeproblemer, allergi og bronkitis, hvor akupunktur har en gavnlig effekt og er med til at forbedre lungefunktionen.</p>
    ...
    <p>Vi har rigtig gode erfaringer med behandling af vejrtrækningslidelser, og langt de fleste oplever øget livskvalitet efter et behandlingsforløb.</p>''',
)
...
article(
    ...
    '''    <p>En af de lidelser, vi har allerbedst erfaringer med at behandle ved hjælp af akupunktur, er smerter i ryg og bevægeapparat. Akupunkturen kan rette op på kroppens skævheder og dermed lindre smerten. Ofte oplever vi, at patienter, der har været plaget af smerter i mange år, ender med at blive smertefri.</p>
...
article(
    ...
    <p>På Akupunkturklinik Charlotte Kuszon har vi stor erfaring inden for behandling af hormonforstyrrelser med akupunktur. Vi kan hjælpe dig med at finde tilbage til en harmonisk balance i kroppen, så du igen kan fungere normalt.</p>
    <h3>Holistisk opfattelse</h3>
    <p>Vi lægger vægt på en god dialog med vores patienter gennem hele behandlingsforløbet.</p>
    <p>Vores holistiske anskuelse af kroppen betyder, at vi ser på problemer i sammenhæng og gør meget ud af at finde frem til den egentlige årsag. Derved kan vi behandle problemet bedst muligt.</p>''',
)
