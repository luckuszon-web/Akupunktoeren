...
body = f'''  <section class="section">
    <div class="container article-grid">
      <div>
        ...
        <p>Har du brug for professionel behandling, eller er du i tvivl om, hvordan vi bedst kan hjælpe dig, er du velkommen til at kontakte os via formularen herunder.</p>

        <form id="kontakt-formspree-form" class="contact-form" action="https://formspree.io/f/xwlkgnke" method="POST">
          <div class="form-message success" id="kontakt-form-success" hidden>Tak for din henvendelse! Vi vender tilbage hurtigst muligt.</div>
          <div class="form-message error" id="kontakt-form-error" hidden>Der opstod en fejl. Prøv igen, eller ring til os på 31 60 88 80.</div>
      ...
      <div class="article-aside">
        ...
        <p style="font-size:0.95rem;">Tøv ikke med at kontakte os, hvis du har spørgsmål om vores behandlinger, eller hvis du ønsker vejledning om, hvordan vi kan hjælpe dig. Vi besvarer henvendelser inden for 1–3 hverdage. Er din henvendelse akut, er du meget velkommen til at ringe til os.</p>
        <ul class="check-list on-light">
          <li>{icon("check")} <span>Få svar på din henvendelse inden for 1-3 hverdage</span></li>
          <li>{icon("check")} <span>Erfarne fagfolk med mangeårig erfaring</span></li>
        </ul>
